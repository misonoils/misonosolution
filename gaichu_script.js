...
function applyPageLanguage(lang) {
  if (lang === 'jp') {
    ...
    document.getElementById("subtitle").textContent = "害虫対策";
    ...
    document.getElementById("subtitle").textContent = "Insect and Pest";
...
function openDriveFile(url) {
  ...
  // optional: if you have a visible "Open in Google Drive" link
