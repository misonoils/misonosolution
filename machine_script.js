...
function switchLanguage(lang) {
    if (lang === 'jp') {
        ...
        document.getElementById("subtitle").innerHTML = "機械故障と使い方";
        ...
        document.getElementById("subtitle").innerHTML = "Machine Failures and Instructions";
...
function openDriveFile(url) {
    let fileID = url.split('/d/')[1].split('/view')[0]; // Extract file ID
