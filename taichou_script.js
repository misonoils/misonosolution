...
function switchLanguage(lang) {
  ...
  // reflect choice in URL (no reload)
  const url = new URL(window.location.href);
...
function applyPageLanguage(lang) {
  if (lang === 'jp') {
    ...
    document.getElementById("subtitle").textContent = "体調不良・怪我";
    ...
    document.getElementById("subtitle").textContent = "Illness or Injury";
  ...
  // Language-aware solution links when both URLs are provided
...
function openDriveFile(url) {
  ...
  // Optional "Open in Google Drive" button
