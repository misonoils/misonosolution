...
function switchLanguage(lang) {
  ...
  // reflect ?lang= in the URL (no reload)
  const url = new URL(window.location.href);
...
function applyPageLanguage(lang) {
  if (lang === 'jp') {
    ...
    document.getElementById("subtitle").textContent = "郵便・宅配便";
    ...
    document.getElementById("subtitle").textContent = "Postal and Courier";
...
// --- Google Drive file modal (robust parsing) ---
